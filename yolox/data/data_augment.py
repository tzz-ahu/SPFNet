...
def augment_hsv(img,img1,timg,timg1, hgain=5, sgain=30, vgain=30):
...
def _mirror(image, image1,timg,timg1,boxes, prob=0.5):
    ...
    return image,image1,timg,timg1,boxes
...
class TrainTransform:
    ...
    def __call__(self, image,image1,timg,timg1, targets, input_dim):
        ...
        if len(boxes) == 0:
            ...
            return image,image1,timage,timage1,targets
        ...
        if random.random() < self.hsv_prob:
            augment_hsv(image,image1,timg,timg1)

        image_t, image_t1,timage_t,timage_t1,boxes = _mirror(image,image1,timg,timg1, boxes, self.flip_prob)
        ...
        return image_t, image_t1,timage_t,timage_t1,padded_labels
...
class ValTransform:
    ...
    def __call__(self, img, img1,timg,timg1,res, input_size):
        ...
        return img,img1,timg, timg1,np.zeros((1, 5))
